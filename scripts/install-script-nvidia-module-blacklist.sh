...
options nvidia NVreg_RegistryDwords="NvSwitchBlacklist=all;RmDisableFabricManager=1;RmUseSwGsp=0;NvLinkDisable=1"
options nvidia NvLinkDisable=1
options nvidia NvSwitchBlacklist=all
